                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="/Pemesanan" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="id_pemesanan" id="id_pemesanan" class="form-control" value="{{ old('id_pemesanan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="id_pelanggan" class="form-label">ID Pelanggan</label>
                                                            <input type="text" name="id_pelanggan" id="id_pelanggan" class="form-control" value="{{ old('id_pelanggan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="tgl_pesan" class="form-label">Tanggal Pesan</label>
                                                            <input type="date" name="tgl_pesan" id="tgl_pesan" class="form-control" value="{{ old('tgl_pesan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="produk" class="form-label">Produk</label>
                                                            <input type="text" name="produk" id="produk" class="form-control" value="{{ old('produk') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="id_karyawan" id="id_karyawan" class="form-control" value="{{ old('id_karyawan') }}">
                                                        </div>
                                                        <div class="mb-3">
