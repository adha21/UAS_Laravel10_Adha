                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="/Pelanggan/{{ $pelanggan->id }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" value="{{$pelanggan->id_pelanggan}}" name="id_pelanggan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Nama Pelanggan</label>
                                                            <input type="text" value="{{$pelanggan->nm_pelanggan}}" name="nm_pelanggan" class="form-control" id="exampleInputPassword1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">No. Handphone</label>
                                                            <input type="text" value="{{$pelanggan->hp_pelanggan}}" name="hp_pelanggan" class="form-control" id="exampleInputPassword1">
                                                        </div>
