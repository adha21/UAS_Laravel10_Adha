                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="/Pelanggan" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="nm_pelanggan" id="nm_pelanggan" class="form-control" value="{{ old('nm_pelanggan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="hp_pelanggan" class="form-label">No. Handphone</label>
                                                            <input type="text" name="hp_pelanggan" id="hp_pelanggan" class="form-control" value="{{ old('hp_pelanggan') }}">
                                                        </div>
