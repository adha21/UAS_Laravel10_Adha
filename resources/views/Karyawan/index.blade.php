                        ...
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                ...
                                <div class="card-header">
                                    <div class="d-flex justify-content-start mb-3"><a href="/Karyawan/tambah" class="btn btn-primary btn-sm"><i class="fa-solid fa-user-plus"></i> Tambah Data</a></div>
                                </div>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <tbody>
                                            @forelse ( $karyawan as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->hp_karyawan}}</td>
                                                    <td>
                                                        <a href="/Karyawan/edit/{{$data->id}}" class="btn btn-info btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-body">
                                                                Yakin Data Karyawan {{$data->nm_karyawan}} ingin dihapus?
                                                            </div>
