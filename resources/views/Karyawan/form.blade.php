                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="/Karyawan" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="nm_karyawan" id="nm_karyawan" class="form-control" value="{{ old('nm_karyawan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="alamat_karyawan" class="form-label">Alamat</label>
                                                            <input type="text" name="alamat_karyawan" id="alamat_karyawan" class="form-control" value="{{ old('alamat_karyawan') }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="hp_karyawan" class="form-label">N0. Handphone</label>
                                                            <input type="text" name="hp_karyawan" id="hp_karyawan" class="form-control" value="{{ old('hp_karyawan') }}">
                                                        </div>
