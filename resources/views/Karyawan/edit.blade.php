                                                ...
                                                <div class="card-body">
                                                    <form method="post" action="/Karyawan/{{ $karyawan->id }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" value="{{$karyawan->id_karyawan}}" name="id_karyawan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Nama Karyawan</label>
                                                            <input type="text" value="{{$karyawan->nm_karyawan}}" name="nm_karyawan" class="form-control" id="exampleInputPassword1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Alamat</label>
                                                            <input type="text" value="{{$karyawan->alamat_karyawan}}" name="alamat_karyawan" class="form-control" id="exampleInputPassword1">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">No. Handphone</label>
                                                            <input type="text" value="{{$karyawan->hp_karyawan}}" name="hp_karyawan" class="form-control" id="exampleInputPassword1">
                                                        </div>
